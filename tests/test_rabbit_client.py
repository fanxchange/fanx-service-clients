...
from serviceclients.queue.rabbit import RabbitQueue
from serviceclients.queue.rabbit import AsyncConsumer

TEST_QUEUE = 'test.tickets.test'
...
class TestRabbitQueue(unittest.TestCase):
    ...
    def test_get_messages1(self):
        ...
        self.queue.get_messages(TEST_QUEUE, process_msg2)
